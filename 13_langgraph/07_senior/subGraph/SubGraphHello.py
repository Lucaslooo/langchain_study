...
# 创建主图构建器并添加子图节点
maingraph_builder = StateGraph(AtguiguState)
maingraph_builder.add_node("sub_node",subgraph)
maingraph_builder.add_edge(START,"sub_node")
maingraph_builder.add_edge("sub_node",END)
...
print(maingraph.invoke({"messages": ["main-graph"]}))
